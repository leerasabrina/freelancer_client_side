 ...
 */}
  ...
  <div className="relative group">
    ...
    <div className="absolute right-0 mt-2 w-56 rounded-lg bg-white shadow-lg p-4 z-50 dark:bg-gray-800 dark:text-white opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
